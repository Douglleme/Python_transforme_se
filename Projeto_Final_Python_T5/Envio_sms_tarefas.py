...
def enviar_sms_para_a_lista_de_contatos_cadastrados(arquivo_csv):
    with open(arquivo_csv, newline='') as csvfile:
        reader = csv.reader(csvfile)
        for row in reader:
            numero_destinatario = row[0]
...
arquivo_csv = input("C:\Users\LENOVO\Desktop\Projeto_Final_Python_T5\celulares_cadastrados.csv")

enviar_sms_para_a_lista_de_contatos_cadastrados(arquivo_csv)